...
/**
 * HTTP message converter for JSON to gRPC protocol buffer messages in Spring WebMVC.
 * <p>
...
public class GrpcJsonHttpMessageConverter extends AbstractHttpMessageConverter<Message> {
	 ...
	 * @throws HttpMessageConversionException if the class does not have a valid
	 * {@code newBuilder()} method or if the method cannot be invoked
	 */
